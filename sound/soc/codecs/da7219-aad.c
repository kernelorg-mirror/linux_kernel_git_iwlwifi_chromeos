...
static irqreturn_t da7219_aad_irq_thread(int irq, void *data)
{
	...
	srm_st = snd_soc_component_read32(component, DA7219_PLL_SRM_STS) & DA7219_PLL_SRM_STS_MCLK;
...
static void da7219_aad_handle_gnd_switch_time(struct snd_soc_component *component)
{
	...
	jack_det = snd_soc_component_read32(component, DA7219_ACCDET_CONFIG_2)
