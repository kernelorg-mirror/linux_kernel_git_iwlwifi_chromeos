...
static struct mtk_icc_node *mt8196_icc_nodes[] = {
...
static struct mtk_icc_desc mt8196_icc = {
	.nodes = mt8196_icc_nodes,
	.num_nodes = ARRAY_SIZE(mt8196_icc_nodes),
};

static const struct of_device_id emi_icc_of_match[] = {
	{ .compatible = "mediatek,mt8196-dvfsrc", .data = &mt8196_icc },
	{ },
};
