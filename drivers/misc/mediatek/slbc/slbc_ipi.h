...
#if IS_ENABLED(CONFIG_MTK_SLBC_IPI) && IS_ENABLED(CONFIG_MTK_TINYSYS_SCMI)
...
int emi_pmu_counter(int argv1, int argv2, int argv3);
int emi_pmu_set_ctrl(int argv1, int argv2, int argv3);
int emi_gid_pmu_counter(int argv1, int argv2);
int emi_pmu_read_counter(int idx);
int emi_gid_pmu_read_counter(void *ptr);
int emi_slc_test_result(void);
int _slbc_ach_scmi(unsigned int cmd, enum slc_ach_uid uid, int gid,
...
#endif /* IS_ENABLED(CONFIG_MTK_SLBC_IPI) && IS_ENABLED(CONFIG_MTK_TINYSYS_SCMI */
