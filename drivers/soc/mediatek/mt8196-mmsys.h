...
/* DISPSYS1 */
#define MT8196_COMP_OUT_CB1_MOUT_EN			0xd08
#define MT8196_COMP_OUT_CB2_MOUT_EN				0xd10
...
#define MT8196_SPLITTER_OUT_CB6_MOUT_EN			0xf4c
#define MT8196_DISP_SPLITTER_IN_CB_TO_COMP_OUT_CB1		BIT(1)
#define MT8196_DISP_SPLITTER_IN_CB_TO_COMP_OUT_CB2		BIT(2)
...
#define MT8196_DISP_SPLITTER_IN_CB_TO_COMP_OUT_CB3		BIT(3)
...
#define MT8196_OVL_EXDMA_ULTRA_SEL0			0x040
#define MT8196_OVL_EXDMA_SEL_DSI0				0
#define MT8196_OVL_EXDMA_SEL_DP_INTF0				4
#define MT8196_OVL_EXDMA_SEL_DP_INTF1				5
#define MT8196_OVL_EXDMA_SEL_DVO0				6
#define MT8196_OVL_EXDMA_PRE_ULTRA_SEL0			0x048
#define MT8196_OVLSYS_GCE_FRAME_DONE_SEL0		0x090
#define MT8196_FRAME_DONE_OUTPROC0				(6)
...
static const struct mtk_mmsys_default mmsys_mt8196_ovl0_default_table[] = {
	...
	{MT8196_OVLSYS_GCE_FRAME_DONE_SEL0, MT8196_FRAME_DONE_OUTPROC0, GENMASK(6, 0)},
};
...
static const struct mtk_mmsys_routes mmsys_mt8196_disp1_routing_table[] = {
	{
		...
		DDP_COMPONENT_DLI_ASYNC22, DDP_COMPONENT_DSC0,
		MT8196_SPLITTER_IN_CB2_MOUT_EN, MT8196_DISP_DLI_RELAY_TO_SPLITTER_OUT_CB10,
		MT8196_DISP_DLI_RELAY_TO_SPLITTER_OUT_CB10
	}, {
		DDP_COMPONENT_DLI_ASYNC22, DDP_COMPONENT_DSC0,
		MT8196_SPLITTER_OUT_CB10_MOUT_EN, MT8196_DISP_SPLITTER_IN_CB_TO_COMP_OUT_CB1,
		MT8196_DISP_SPLITTER_IN_CB_TO_COMP_OUT_CB1
	}, {
		DDP_COMPONENT_DSC0, DDP_COMPONENT_DP_INTF0,
		MT8196_COMP_OUT_CB1_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB1,
		...
		DDP_COMPONENT_DLI_ASYNC23, DDP_COMPONENT_DSC1,
		MT8196_SPLITTER_IN_CB3_MOUT_EN, MT8196_DISP_DLI_RELAY_TO_SPLITTER_OUT_CB11,
		MT8196_DISP_DLI_RELAY_TO_SPLITTER_OUT_CB11
	}, {
		DDP_COMPONENT_DLI_ASYNC23, DDP_COMPONENT_DSC1,
		MT8196_SPLITTER_OUT_CB11_MOUT_EN, MT8196_DISP_SPLITTER_IN_CB_TO_COMP_OUT_CB3,
		MT8196_DISP_SPLITTER_IN_CB_TO_COMP_OUT_CB3
	}, {
		DDP_COMPONENT_DSC1, DDP_COMPONENT_DP_INTF1,
		MT8196_COMP_OUT_CB2_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB2,
		MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB2
	}, {
		DDP_COMPONENT_DSC1, DDP_COMPONENT_DP_INTF1,
		...
		DDP_COMPONENT_DSC1, DDP_COMPONENT_DSI0,
		MT8196_COMP_OUT_CB2_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB2,
		MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB2
	}, {
		DDP_COMPONENT_DSC1, DDP_COMPONENT_DSI0,
